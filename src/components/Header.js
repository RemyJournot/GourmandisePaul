    ...
    <nav>
      <ul>
        ...
        <li>
          <button
            onClick={() => {
              props.onOpenArticle('allproducts')
            }}
          >
            Mes Produits
          </button>
